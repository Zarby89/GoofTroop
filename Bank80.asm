...
;Update Code for the Liftable Objects !
80C05E   LDA $0B00
80C061   BEQ $80C06B  
80C063   LDA #$0B 
80C065   XBA
...
;$0A = Main Type
80C0E1   TCD
80C0E2   LDX $0A ;0A = Main object Type
80C0E4   JMP ($C0E7,X)
...
dw $C1A4 ;0x02 ;?? 
dw $C1A7 ;0x04 ;?? 
dw $C1AC ;0x06 ;Does the same as 0x00 with extra stuff
dw $C1B6 ;0x08 ;Does the same as 0x00 with extra stuff
dw $C1C0 ;0x0A ;Does the same as 0x00 with extra stuff
dw $C1CE ;0x0C ;Does the same as 0x00 with extra stuff 

80C11D   JSL $808EFC  ;Set the $1A address? 
80C121   LDA #$05 
80C123   STA $1C  
80C125   LDA #$01 
80C127   STA $00 ;Set the sprite alive
80C129   STA $01 ;?
80C12B   STZ $0E 
80C12D   STZ $1E  
80C12F   STZ $35  
...
80C136   LDX $0B  
80C138   CPX #$0A 
80C13A   BNE $80C140 ;IF Sprite index != 0A
80C13C   STZ $05  
80C13E   LDA #$FF 
80C140   STA $2E  
80C142   LDA #$07 
...
80C164   LDA $1A  
80C166   STA $2C  
80C168   JSL $808A53 ;Set $20 using $1A ? 
80C16C   LDA $0B  
80C16E   CMP #$1A 
80C170   BNE $80C188  ;IF Sprite index != 1A (special object afaik)
;Load Special object instead of normal one
80C172   INC $00  
80C174   LDY $8E7E
80C177   LDA $8E7F
...
80C18A   LDY $8E64,X  
80C18D   LDA $8E65,X  
80C190   JSL $8089D7 ;Set Animation Tile Address  
80C194   JSL $808A21 ;Use $23 to do something TODO
...
;Does the same as 0x00 with $1E setted on #$02
80C1AC   JSR $C11D
80C1AF   LDA #$02 
80C1B1   STA $02  
80C1B3   STA $1E  
...
;Does the same as 0x00 with $1E setted on #$03
80C1B6   JSR $C11D
80C1B9   LDA #$02 
80C1BB   STA $03  
80C1BD   STA $1E  
...
80D119  dw $D11B  ;<- wtf is the use of that a JSR directly do $D11B would have been the same...
