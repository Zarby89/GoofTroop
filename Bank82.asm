...
82A2FB   LDA $1D                  
82A2FD   STA $000A                
82A300   JSL $82C3B4 ;Update Tilemap??
82A304   RTS                      
...
82A59B   LDA $C2CD,X              
82A59E   STA $000A                
82A5A1   JSL $82C3B4  ;Update Tilemap??              
82A5A5   RTS                      
----------------         
82A5A6   JSL $808F3B              
82A5AA   RTS                      
...
;4 Blocks ?
82A629   LDA $19 
82A62B   STA $1A ;$0A1A = Count of blocks
82A62D   STZ $1B ;$0A1B = Blocks on Star tiles
82A62F   REP #$10                 
82A631   LDX $1E ;$0A1E = Position of star tiles in ROM
82A633   LDY $0000,X ;Load Star Tile Position
82A636   LDA $1400,Y ;Check if Tile is 
82A639   CMP #$A0 ;A Block
82A63B   BNE $82A63F ;Do not INC $1B otherwise
82A63D   INC $1B ;Increase block count?
82A63F   INX 
82A640   INX 
82A641   DEC $1A ;Decrease Something ?
82A643   BNE $82A633 ;if 1A != 0 loop until it does
82A645   LDA $19
82A647   CMP $1B                  
82A649   BNE $82A6C7 ;Return
82A64B   LDA $0000,X              
82A64E   BMI $82A6A1 
82A650   SEP #$10                 
82A652   STA $1A ;Set $0A1A?
82A654   LSR                      
82A655   LSR                      
82A656   LSR                      
82A657   TAY                      
...
82A661   PLA 
82A662   ORA $80B8,X              
82A665   STA $1144,Y ;Door Related !
82A668   REP #$10                 
82A66A   LDX $1C ;0A1C                 
82A66C   LDA $0001,X 
82A66F   BPL $82A6A1              
...
82A6AD   LDA $0001,X 
82A6B0   AND #$7F                 
82A6B2   STA $000A ;Set bank for the routine below
82A6B5   LDY $0002,X 
82A6B8   BMI $82A6C3              
82A6BA   STY $0013 
82A6BD   SEP #$10 
82A6BF   JSL $82C3B4  ;Update Tilemap/Open Door??             
82A6C3   LDA #$06                 
82A6C5   STA $02                  
82A6C7   SEP #$10                 
82A6C9   RTS                      
...
82C3C8   LSR                      
82C3C9   LSR                      
82C3CA   STA $00 ;Upper bits of 82C452[0]             
82C3CC   LDA $82C452,X            
82C3D0   AND #$0F                 
82C3D2   STA $02 ;Lower bits of 82C452[0]      
82C3D4   STA $06 ;Lower bits of 82C452[0]  
82C3D6   REP #$10                 
82C3D8   LDX $13 
82C3DA   STX $1F 
82C3DC   LDA $00 
...
dw $C621, $C622, $C623, $C633, $C643, $C65F, $C690, $C6A3, $C6A7, $C6B7, $C6D6, $C6F5, $C702, $C709, $C71C, $C729
 
82C55D ;Level 2 Pointers
dw $C74B, $C764, $C765, $C772, $C788, $C7A1, $C7A8, $C7CA, $C7E3, $C7FF, $C80C, $C80D, $C826, $C836, $C85E, $C85F

82C57D ;Level 3 Pointers
dw $C86C, $C876, $C877, $C88A, $C88B, $C88C, $C89F, $C8B2, $C8B3, $C8C3, $C8C4, $C8DA, $C8DB, $C8F1, $C8F2, $C90B, $C90C, $C919, $C932, $C93F, $C952, $C95C, $C96F, $C970, $C98F, $C990   
 
82C5B1 ;Level 4 Pointers
dw $C991, $C9A4, $C9B7, $C9E2, $CA0D, $CA1A, $CA1B, $CA2E, $CA2F, $CA60, $CA6A, $CA80, $CA87, $CA88, $CAB0, $CACC, $CACD, $CAFB, $CB1A, $CB1B, $CB1C, $CB2C, $CB39, $CB3A, $CB44, $CB69, $C9B7, $C9E2, $CA2F, $CA2F
   
82C5ED ;Level 5 Pointers  
db $CB6E, $CB81, $CBA6, $CBCB, $CBF0, $CBF1, $CBF5, $CBF6, $CC0F, $CC3A, $CC4D, $CC54, $CC61, $CC74, $CC75, $CC82, $CCAA, $CCB4, $CCCA, $CCCB, $CCCC, $CCD9, $CCDA, $CCEA, $CD30, $CD31



;Level1 Blocks/Tiles Data   
82C621 ;01
db $00
82C622 ;02
db $00
...
82C643 ;05
db $09 $00 $86 $02 $00 $0A $02 $00 $8A $02 $08 $9A $02 $08 $9E $02 $08 $9A $04 $08 $9E $04 $02 $B4 $05 $02 $38 $05

82C65B ;06
db $10 $18 $84 $04 $08 $18 $05 $08 $98 $05 $08 $18 $06 $08 $A4 $04 $08 $24 $05 $08 $A4 $05 $08 $28 $02 $08 $30 $02 $1A $28 $05 $1A $2C $02 $08 $8C $01 $08 $90 $01 $08 $94 $01 $08 $98 $01 $08 $9C $01 

82C690 ;07
db $06 $08 $1C $05 $08 $20 $05 $08 $A4 $03 $1A $8C $03 $1A $20 $02 $1A $B0 $03 

82C6A3 ;08
db $01 $04 $38 $01      
   
82C6A7 ;09
db $05 $18 $9A $02 $18 $36 $01 $18 $06 $06 $18 $B8 $05 $18 $38 $06

82C6B7 ;10
db $0A $00 $04 $06 $00 $10 $06 $00 $A0 $04 $08 $2C $05 $08 $30 $05 $08 $38 $04 $08 $B8 $04 $08 $38 $05 $08 $B8 $05 $08 $38 $06

82C6D6 ;11
db $0A $08 $84 $01 $08 $88 $05 $08 $08 $06 $08 $14 $03 $08 $94 $03 $08 $14 $04 $08 $94 $04 $08 $B0 $05 $08 $A8 $01 $08 $28 $02

82C6F5 ;12
db $04 $1A $98 $03 $1A $A4 $03 $1A $30 $05 $1A $34 $03
  
   
82C702 ;13
db $02 $1A $98 $04 $1A $32 $02
82C709 ;14
...
82C74B  .db $08 $00 $10 $04 $00 $94 $03
...
82CD2B  .db $9C $04 $1A $8C $03 $00 $00
;End of Blocks Data
