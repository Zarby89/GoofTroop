...
;Sprite Handlers (sort of sprite but they use less ram and can only have 2 per map)
...
dw $B624 ;0x2C ;Moving Bridge on level3? NOT SURE also breakable walls
...
dw $D94C ;0x42 ;Order Switch; also used for O P E N puzzle with subtype 02
...
----------------         
--------data--------     
81C43E  .db $46 $C4 $53 $C4      
----------------         
--------unidentified--------
81C442  .db $86 $C4 $93 $C4      
----------------         
--------sub start--------
81C446   JSR $C4C4                
81C449   DEC $0F                  
...
81F7A4   JMP ($F7A7,X)            
--------data--------     
81F7A7  .db $AF $F7 $EB $F7 $A6 $FA $90 $E7
----------------         
81F7AF   LDX $03                  
81F7B1   JSR ($F7C0,X)            
81F7B4   JSR $FD2D                
